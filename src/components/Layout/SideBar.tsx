...
const SideBar = () => {
  ...
  return (
    <div className="group fixed bottom-0 left-0 top-[118px]  z-50 flex w-[50px] flex-col border-r border-r-borderColor1 bg-bg-dark transition-all duration-500 ease-in-out hover:w-[84px]">
      <CustomIconButton
        icon={home}
        size={25}
