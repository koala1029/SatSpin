...
const FundDialogItem = ({ name, symbol, image }: FundDialogItemProps) => {
  return (
    <div className="bg-bgColor10 flex w-[300px] lg:w-[400px] cursor-pointer items-center justify-between rounded-lg p-5 text-center font-space text-lg lg:text-xl">
